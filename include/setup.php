...
function rm_theme_styles(){
	...
	// SCRIPTS
	wp_enqueue_script('jquery', "/assets/js/jquery.js");
	wp_enqueue_script('theme-js', get_template_directory_uri() . '/assets/js/myconfig.js', array('jquery'), '', true);
	// wp_enqueue_script('slim', "https://code.jquery.com/jquery-3.4.1.slim.min.js");
